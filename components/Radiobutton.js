...
function Radiobutton({platform, name}) {
  return (
    <label className="cursor-pointer">
        ...
        <div className="mt-8 w-72 max-w-xl bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 bg-gray-800 border-gray-700 hover:bg-gray-700  ring-1 transition-all peer-checked:text-slate-50 peer-checked:ring-offset-1 w-50">
